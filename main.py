...
if __name__ == '__main__':
    ...
    encrypted_msg_list = encrypt_message(message) # Encrypting the input message
    encrypted_txt = ""
    ...
    decrypted_txt = decrypt(encrypted_msg_list) #Decrypting the encrypted message for verification
